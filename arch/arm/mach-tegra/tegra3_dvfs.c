...
int user_mv_table[MAX_DVFS_FREQS] = {
	800, 825, 850, 875, 900, 912, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1165, 1175, 1190, 1237};
#endif
...
//Nexus 7 - faking speedo id = 4, process id =2
	CPU_DVFS("cpu_g",  4, 2, MHZ, 520, 540, 700, 720,  860,  880, 1050, 1150, 1200, 1240, 1300, 1340, 1380, 1400, 1500, 1540, 1600, 1624),
...
/* Core voltages (mV):		           950,   1000,   1050,   1100,   1150,    1200,    1250,    1300,    1350 */
	...
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  520000,  520000,  520000,  520000),
#endif
#else
