...
static const unsigned int cpu_cold_offs_mhz[MAX_DVFS_FREQS] = {
	  50,  50,  50,  50,  50,  50,  50,  50,  50,   50,   50,   50,   50,   50,   50,   50,   50,   25};
...
static struct dvfs cpu_dvfs_table[] = {
	/* Cpu voltages (mV):	      800, 825, 850, 875,  900,  912,  975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1190, 1200, 1237 */
	...
	CPU_DVFS("cpu_g",  7, 0, MHZ, 460, 480, 550, 570,  680,  700,  820,  970, 1040, 1080, 1150, 1200, 1280, 1360, 1500, 1540, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 1, MHZ, 480, 500, 650, 670,  780,  800,  990, 1040, 1100, 1200, 1300, 1320, 1380, 1400, 1500, 1540, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 2, MHZ, 520, 540, 700, 720,  860,  880, 1050, 1150, 1200, 1240, 1300, 1340, 1380, 1400, 1500, 1540, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 3, MHZ, 550, 550, 750, 770,  910,  940, 1150, 1230, 1280, 1320, 1340, 1360, 1380, 1400, 1500, 1540, 1600, 1700),
	CPU_DVFS("cpu_g",  7, 4, MHZ, 550, 550, 750, 770,  940,  940, 1160, 1280, 1300, 1330, 1340, 1360, 1380, 1400, 1500, 1540, 1600, 1700),
...
static struct dvfs core_dvfs_table[] = {
...
#ifdef GPU_OC_446
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  446000,  446000,  446000),
	...
	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  446000,  446000,  446000),
...
#endif
#ifdef GPU_OC_484
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  484000,  484000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  484000,  484000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  484000,  484000,  484000),
#endif
#ifdef GPU_OC_500
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  500000,  500000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  500000,  500000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  500000,  500000,  500000),
#endif
#ifdef GPU_OC_520
	CORE_DVFS("vde",    0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  520000,  520000),
	CORE_DVFS("mpe",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("2d",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("epp",    0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("3d",     0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    0, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("se",     0, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),

	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  446000,  520000,  520000,  520000),
#endif
#else
...
#ifdef CONFIG_GPU_OVERCLOCK
#ifdef GPU_OC_446
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  446000,  446000,  446000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  446000,  446000,  446000),
...
#endif
#ifdef GPU_OC_484
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  484000,  484000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  484000,  484000,  484000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#ifdef GPU_OC_500
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  500000,  500000,  500000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  500000,  500000,  500000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#ifdef GPU_OC_520
	CORE_DVFS("cbus",   0, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  520000,  520000,  520000),
	CORE_DVFS("cbus",   1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  437000,  520000,  520000,  520000),
	CORE_DVFS("cbus",   2, 1, KHZ,        1, 247000, 304000, 352000, 400000,  437000,  484000,  520000,  600000),
	CORE_DVFS("cbus",   3, 1, KHZ,        1, 484000, 484000, 484000, 484000,  484000,  484000,  484000,  484000),
#endif
#else
